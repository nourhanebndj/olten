    ...
    <section class="categories-section">
        <div class="section-header">
            <h2 class="section-title">
                Explorez nos <span class="site-name">Services</span>
            </h2>
            ...
            <div class="carousel-track">
                @foreach($services as $service)
                    <a href="#" class="category-card">
                        ...
                        <i class="{{ $service->icon }} category-icon"></i>
                        <h5>{{ $service->nom }}</h5>
                    </a>
                @endforeach
            </div>
                    ...
                    <div class="card-content">
                        ...
                        <div class="card-footer">
                            <div>
                                ...
                                <p class="card-price">{{ number_format($ad->price_per_day, 2) }} €</p>
                            </div>
...
<section class="cta-section">
    ...
    <a href="{{ \Illuminate\Support\Facades\Route::has('ads.create') ? route('ads.create') : url('/annonces/creer') }}" class="cta-btn">
