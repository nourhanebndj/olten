...
<div class="page-inner">
    ...
    <form action="{{ route('admin.users.store') }}" method="POST" enctype="multipart/form-data"
        ...
        <div class="mb-4">
            ...
            <select name="role" id="role" class="w-full border rounded-lg p-3 focus:outline-none focus:ring-2 focus:ring-red-500">
        ...
        <div class="flex flex-col md:flex-row gap-4 mb-4">
            ...
            <div class="flex-1">
                ...
                <select name="gender" id="gender" class="w-full border rounded-lg p-3 focus:outline-none focus:ring-2 focus:ring-red-500">
        ...
        <div class="mb-4">
            ...
            <textarea name="about_me" id="about_me" rows="3" class="w-full border rounded-lg p-3 focus:outline-none focus:ring-2 focus:ring-red-500">{{ old('about_me') }}</textarea>
        </div>
        ...
        <div class="mb-4 flex flex-wrap gap-4">
            <div class="flex-1 min-w-[200px]">
                ...
                <input type="text" name="x_com" id="x_com" class="w-full border rounded-lg p-3 focus:outline-none focus:ring-2 focus:ring-red-500" value="{{ old('x_com') }}">
            </div>
            <div class="flex-1 min-w-[200px]">
                <label for="facebook" class="block text-gray-700 font-medium mb-1">Facebook</label>
                <input type="text" name="facebook" id="facebook" class="w-full border rounded-lg p-3 focus:outline-none focus:ring-2 focus:ring-red-500" value="{{ old('facebook') }}">
            </div>
            <div class="flex-1 min-w-[200px]">
                <label for="linkedin" class="block text-gray-700 font-medium mb-1">LinkedIn</label>
                <input type="text" name="linkedin" id="linkedin" class="w-full border rounded-lg p-3 focus:outline-none focus:ring-2 focus:ring-red-500" value="{{ old('linkedin') }}">
            </div>
        </div>
        ...
        <div class="mb-4 flex flex-wrap gap-4">
            <div class="flex-1 min-w-[200px]">
                ...
                <input type="text" name="instagram" id="instagram" class="w-full border rounded-lg p-3 focus:outline-none focus:ring-2 focus:ring-red-500" value="{{ old('instagram') }}">
            </div>
            <div class="flex-1 min-w-[200px]">
                <label for="youtube" class="block text-gray-700 font-medium mb-1">YouTube</label>
                <input type="text" name="youtube" id="youtube" class="w-full border rounded-lg p-3 focus:outline-none focus:ring-2 focus:ring-red-500" value="{{ old('youtube') }}">
            </div>
            <div class="flex-1 min-w-[200px]">
                <label for="tiktok" class="block text-gray-700 font-medium mb-1">TikTok</label>
                <input type="text" name="tiktok" id="tiktok" class="w-full border rounded-lg p-3 focus:outline-none focus:ring-2 focus:ring-red-500" value="{{ old('tiktok') }}">
            </div>
        </div>
        ...
        <div class="mb-4 flex flex-wrap gap-4">
            <div class="flex-1 min-w-[200px]">
                ...
                <input type="text" name="whatsapp" id="whatsapp" class="w-full border rounded-lg p-3 focus:outline-none focus:ring-2 focus:ring-red-500" value="{{ old('whatsapp') }}">
            </div>
        </div>

        {{-- Boutons --}}
        <div class="flex items-center justify-between mt-4">
            <a href="{{ route('admin.users.index') }}" class="text-gray-600 hover:text-gray-800 underline">Annuler</a>
            <button type="submit" class="ml-auto px-4 py-2 text-white rounded-2xl border transition" style="background-color: #2c2c2c; border: 1px solid #2c2c2c;">
                Ajouter
            </button>
        </div>
